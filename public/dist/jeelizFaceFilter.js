  ...
  if (typeof window !== "undefined") {
    window.JEELIZFACEFILTERGEN = function () {
      function Jb(a) {
        ...
        this.A = function () {
          this.De(q.ab);
          g.fg({ Ib: q.Ib, Ac: q.Ac, Hb: q.Hb });
        };
        this.lf = function (m) {
          return c[m];
        };
        this.Tb = function (m) {
          ["s31", "s33", "s26"].forEach(function (r) {
            G.T(r, [{ type: "2f", name: "u20", value: m }]);
          });
          c &&
        ...
        this.De = function (m) {
          ...
          c = m.map(function (x, B) {
            ...
            return (r = B = 0 === B ? Kb.instance(x) : Lb.instance(x));
          });
          d = c[0];
          g = c[k - 1];
      ...
      function tb(a, c, d) {
        var g = 1,
          k = 0;
        for (d = c + d - 1; d >= c; --d) (k += g * fb(a, d)), (g *= 2);
        return k;
      }
      function ub(a) {
        a = a.data;
        a =
          "undefined" === typeof btoa
            ...
            : atob(a);
        for (var c = a.length, d = new Uint8Array(c), g = 0; g < c; ++g)
          d[g] = a.charCodeAt(g);
        return d;
      }
      function gb(a) {
        ...
        if ("undefined" === typeof gb(a).nb) {
          ...
          for (
            ...
            var m = q * n,
              ...
              y = tb(c, m + 1, a);
            m = m + 1 + a;
            for (var C = p.length, x = 0, B = m; B < m + C; ++B)
              (p[x] = fb(c, B, !0)), ++x;
            for (C = m = 0; C < d; ++C) m += p[C] * Math.pow(2, -C - 1);
            k[n] =
              0 === m && 0 === y
                ? 0
                : r * (1 + m) * Math.pow(2, 1 + y - Math.pow(2, a - 1));
          }
          a = k;
        } else if (((g = gb(a)), (a = g.nb), 0 === a)) a = new Uint8Array(g.nb);
        else {
          d = g.n;
          g = ub(g);
          c = new Uint32Array(d);
          for (k = 0; k < d; ++k) c[k] = tb(g, k * a, a);
          a = c;
        }
        return a;
      }
      ...
      function Fa(a, c, d, g, k) {
        a = 4 * (3 * c + a) + d;
        return g + (V.buffer[a] / 255 + V.buffer[a + 12] / 65025) * (k - g);
      }
      function ib() {
      ...
      function vb() {
        na !== ja.pause &&
          (ba.isCleanGLStateAtEachIteration &&
            ...
            b.pixelStorei(b.UNPACK_FLIP_Y_WEBGL, !1),
            G.Ja()),
          qa.Fc(Ob, Nb, Pb, xb, Qb, ba.animateProcessOrder));
      }
      function Ob() {
        va.fa();
        if (!K.Ab)
          if (K.zb)
            K.element.needsUpdate &&
              (K.K.ge(K.element.videoWidth, K.element.videoHeight),
              K.K.Sb(K.element.arrayBuffer),
              (K.element.needsUpdate = !1));
          else {
            var a = K.element.currentTime,
              c = a - K.Lb;
            0 > c && ((K.Lb = a), (c = 0));
            1e3 * c < ea.pg || ((K.Lb += c), K.K.refresh());
          }
        a = qa.mf();
        da.update(a, Ba);
        for (c = 0; c < a; ++c) {
          ...
          G.set("s63");
          var d = Ba[da.wd()];
          G.G("u45", 1 + Oa.Gc * (Math.cos(d.ry) - 1));
          S.Ca && G.G("u44", d.rz);
          da.pe("u43");
          Z.Ya.S();
          K.K.h(0);
      ...
      function xb() {
        va.mg();
        ba.isCleanGLStateAtEachIteration &&
          (va.reset(), aa.reset(), b.enable(b.DEPTH_TEST));
        S.Wb && S.Wb(da.Md() ? Ba : Ba[0]);
        ba.isCleanGLStateAtEachIteration &&
          (b.disable(b.BLEND), P.reset(), P.Ba());
      }
      function Pb() {
        for (var a = 0; a < da.sa(); ++a)
          if (da.Ff(a)) {
            var c = a,
              ...
              q = 2 * c;
            d.lb = Fa(1, q, 3, 0, 1);
            k.detected = wa.aa(k.detected, d.lb, ea.ve);
            d.x = Fa(0, q, 1, -1, 1);
            d.y = Fa(0, q, 2, -1, 1);
            d.ca = Fa(0, q, 3, 0, 1);
            if (d.lb < ba.multiDetectionThresholdFactors[0] * ba.threshold)
              (d.va = Math.floor(d.va / 2)), S.Ca && ((k.rz = 0), (k.ry = 0));
            else {
              var n = V.bb;
              d.rx = Fa(1, q, 0, -n[0], n[0]);
              d.ry = Fa(1, q, 1, -n[1], n[1]);
              d.ya = Fa(1, q, 2, -n[2], n[2]);
              for (n = 0; n < V.ba; ++n) d.rd[n] = V.Va[n](Fa(2, q, n, 0, 1));
              q = d.ca * V.ce;
              g.dx = d.x - k.xRaw;
              g.dy = d.y - k.yRaw;
              g.ec = q - k.sRaw;
              ...
              g =
                (1 -
                  $a.Fb(
                    ...
                    Math.sqrt(g.dx * g.dx + g.dy * g.dy + g.ec * g.ec) / n
                  )) *
                (1 -
                  $a.Fb(
                    sa.rotationFactorRange[0],
                    sa.rotationFactorRange[1],
                    Math.sqrt(g.bc * g.bc + g.cc * g.cc + g.dc * g.dc) / n
                  )) *
                $a.Fb(sa.qualityFactorRange[0], sa.qualityFactorRange[1], d.lb);
              c = p[++kb[c] % p.length] = g;
              for (n = 0; n < p.length; ++n) c = Math.min(c, p[n]);
              c = Math.max(0.5, c);
              g = Math.min(c, g);
              p = wa.aa(sa.alphaRange[1], sa.alphaRange[0], Math.pow(g, ea.xe));
              ...
              k.rz = S.Ca
                ? k.rz + sa.followZRotAlphaFactor * p * d.ya
                : wa.aa(k.rz, d.ya, p);
              c = k.sRaw * Oa.ac * Math.sin(k.ry);
              q = (Math.sin(k.rz) * c) / Qa;
      ...
      function yb() {
        Z.Ya = aa.instance({ isPot: !0, isFloat: !1, width: Pa.kf() });
        var a = {
          width: ea.le,
          height: da.sa(),
          isFloat: !0,
      ...
      function lb() {
        ...
        G.T("s64", [
          ...
          { type: "1i", name: "u41", value: 1 },
          { type: "1f", name: "u49", value: ea.kg },
          { type: "1f", name: "u50", value: ba.threshold },
          {
            type: "3f",
            name: "u48",
            value: [V.N[0] * Z.F[0], V.N[1] * Z.F[1], V.N[2]],
          },
          { type: "1f", name: "u43", value: 0.5 },
        ...
        G.T("s61", [
          ...
          { type: "1f", name: "u54", value: Z.F[0] },
          { type: "2f", name: "u53", value: [0, 0.5 / da.sa()] },
        ]);
      }
      function mb() {
        Z.F[0] = 1;
      ...
      function Sb(a) {
        if (S.Ma) zb("string" === typeof S.Ma ? JSON.parse(S.Ma) : S.Ma, a);
        else {
          var c = S.Xc;
      ...
      function zb(a, c) {
        if (a.exportData) {
          ...
          V.ce = d.dsMean ? 1 + d.dsMean : 1;
          Oa.Gc = 0.4;
          Oa.ac = 0.7;
          "undefined" !== typeof d.fgScaleXFactor && (Oa.Gc = d.fgScaleXFactor);
          "undefined" !== typeof d.fgDisplaceXFactor &&
            (Oa.ac = d.fgDisplaceXFactor);
        }
        V.ba || (V.ba = ea.Sd);
        if (!V.Va) for (V.Va = [], d = 0; d < V.ba; ++d) V.Va.push(ea.Xe);
        c(a);
      }
      function Tb() {
        if (
      ...
      function Ub() {
        ...
        da.pe("u43");
        var d = 1,
          g = da.gg(Sa, Ba, Z.u / Z.L);
        da.Md() &&
          (g &&
            ((d = 0), (Sa[a].va = 0), (c.isDetected = !1), (c.detected = 0)),
          G.G("u51", d));
        G.bg("u47", Ta.get(a));
        P.l(!1, !1);
        if (da.Ld() || g)
          b.viewport(1, a, 1, 1), G.set("s65"), G.G("u51", d), P.l(!1, !1);
        da.Ld() && (b.viewport(2, a, 1, 1), G.set("s66"), P.l(!1, !1));
        V.za.sync();
      }
      function Ab() {
        K.K && K.K.remove();
        K.zb = K.element.isFakeVideo ? !0 : !1;
        if (K.zb) {
          var a = Bb();
          a = {
            isFlipY: !1,
            array: K.element.arrayBuffer,
            width: a.w,
            height: a.Ea,
            isKeepArray: !0,
          };
      ...
      function Ja() {
        var a = [{ type: "mat2", name: "u40", value: K.B }];
        G.T("s62", [{ type: "1i", name: "u1", value: 0 }].concat(a));
        G.T("s63", a);
      }
      function Ka() {
        var a = [0.5, 0.5],
        ...
        G.T("s64", [{ name: "u52", type: "1f", value: Qa }]);
        K.B[0] = 0;
        K.B[1] = 0;
        K.B[2] = 0;
        K.B[3] = 0;
        ...
        pa.flipX && ((K.B[0] *= -1), (K.B[2] *= -1));
        K.Ab || ((K.B[1] *= -1), (K.B[3] *= -1));
      }
      function Bb() {
        var a = {
          w: K.element.videoWidth || K.element.width,
          Ea: K.element.videoHeight || K.element.height,
        };
        if (!a.w || !a.Ea || 4 > a.w || 4 > a.Ea)
          throw Error(
            "INVALID VIDEO DIMENSIONS - width = " + a.w + " height = " + a.Ea
          );
        return a;
      }
      function nb() {
        var a = Bb(),
          c = K.F[0] !== a.w || K.F[1] !== a.Ea;
        c && ((K.F[0] = a.w), (K.F[1] = a.Ea));
        return c;
      }
      function bb(a, c) {
      ...
      function Cb(a, c, d) {
        ...
        X.Zc(K.Ra, pa.deviceId);
        X.get(
          K.element ? K.element : X.Ad(),
          function (g) {
            c && c(g);
            d(g);
          },
      ...
      function Ia(a) {
        na !== ja.error && ((na = ja.error), S.Qa && S.Qa(a));
      }
      var wa = {
          sh: function (a) {
        ...
        G = (function () {
          function a(f, l, H) {
            ...
            f.shaderSource(l, H);
            f.compileShader(l);
            return f.getShaderParameter(l, f.COMPILE_STATUS) ? l : null;
          }
          function c(f, l, H) {
            l = a(f, f.VERTEX_SHADER, l);
            H = a(f, f.FRAGMENT_SHADER, H);
            f === b && n.push(l, H);
            var M = f.createProgram();
            f.attachShader(M, l);
            f.attachShader(M, H);
            f.linkProgram(M);
            return M;
          ...
          function g(f, l) {
            ...
            if (!l.v) {
              ...
              l.ib = l.ib || ["a0"];
              l.Oa = l.Oa || [2];
              l.precision = l.precision || x;
              l.id = y++;
              void 0 !== l.ee &&
                (l.ee.forEach(function (Q, fa) {
                  l.g = l.g.replace(Q, l.Nb[fa]);
                }),
                l.ee.splice(0));
              l.Tc = 0;
              l.Oa.forEach(function (Q) {
                l.Tc += 4 * Q;
              });
              var H = d(l.precision);
              l.xa = c(f, H + l.Aa, H + l.g);
              l.C = {};
              l.i.forEach(function (Q) {
                l.C[Q] = f.getUniformLocation(l.xa, Q);
              });
              l.attributes = {};
              l.Pa = [];
              l.ib.forEach(function (Q) {
                var fa = f.getAttribLocation(l.xa, Q);
                l.attributes[Q] = fa;
                l.Pa.push(fa);
              });
              if (l.j) {
                ...
                r = l;
                m = l.id;
                for (var M in l.j) f.uniform1i(l.C[M], l.j[M]);
              }
              l.ua = !0;
            }
          }
          function k(f) {
            ...
            m !== f.id &&
              ...
              (r = f),
              b.useProgram(f.xa),
              f.Pa.forEach(function (l) {
                0 !== l && b.enableVertexAttribArray(l);
              }));
          }
          function p(f, l, H) {
            g(f, l, H);
            f.useProgram(l.xa);
            f.enableVertexAttribArray(l.attributes.a0);
            m = -1;
            return (r = l);
          }
          function q() {
          ...
          var n = [],
            ...
            I = {
              ...
              s11: {
                g: "uniform sampler2D u1,u12;uniform float u13;const vec4 f=vec4(1.,1.,1.,1.);varying vec2 vv0;void main(){vec4 a=texture2D(u1,vv0),b=texture2D(u12,vv0);gl_FragColor=mix(b,a,u13*f);}",
                i: ["u1", "u12", "u13"],
                j: { u1: 0, u12: 1 },
              },
              s12: {
            ...
            N = {
              ...
              uf: function (f, l, H) {
                l || (l = f);
                v[l] = Object.create(O[f]);
                v[l].zf = !0;
                O[f].Nb &&
                  O[f].Nb.forEach(function (M, Q) {
                    v[l].g = v[l].g.replace(new RegExp(M, "g"), H[Q]);
                  });
                g(b, v[l], l);
              },
              set: function (f) {
              ...
              We: function (f) {
                return "undefined" === typeof v[f] ? !1 : v[f].ua;
              },
              P: function () {
                -1 !== m &&
                  ((m = -1),
                  r.Pa.forEach(function (f) {
                    0 !== f && b.disableVertexAttribArray(f);
                  }));
              },
              Lc: function () {
                var f = 0;
                r.Pa.forEach(function (l, H) {
                  H = r.Oa[H];
                  b.vertexAttribPointer(l, H, b.FLOAT, !1, r.Tc, f);
                  f += 4 * H;
                });
              },
              kd: function () {
              ...
              Ob: function (f) {
                f.vertexAttribPointer(r.Pa[0], 2, f.FLOAT, !1, 8, 0);
              },
              ci: function (f, l) {
                b.uniform1i(r.C[f], l);
              },
              ...
              V: function (f, l, H) {
                b.uniform2f(r.C[f], l, H);
              },
              ie: function (f, l) {
                b.uniform2fv(r.C[f], l);
              },
              bg: function (f, l) {
                b.uniform3fv(r.C[f], l);
              },
              di: function (f, l, H, M) {
                b.uniform3f(r.C[f], l, H, M);
              },
              cg: function (f, l, H, M, Q) {
                b.uniform4f(r.C[f], l, H, M, Q);
              },
              je: function (f, l) {
                b.uniform4fv(r.C[f], l);
              },
              ei: function (f, l) {
                b.uniformMatrix2fv(r.C[f], !1, l);
              },
              fi: function (f, l) {
                b.uniformMatrix3fv(r.C[f], !1, l);
              },
              gi: function (f, l) {
                b.uniformMatrix4fv(r.C[f], !1, l);
              },
              T: function (f, l) {
                N.set(f);
                l.forEach(function (H) {
                  switch (H.type) {
                    case "4f":
                      b.uniform4fv(r.C[H.name], H.value);
                      break;
                    case "3f":
                      b.uniform3fv(r.C[H.name], H.value);
                      break;
                    case "2f":
                      b.uniform2fv(r.C[H.name], H.value);
                      break;
                    case "1f":
                      b.uniform1f(r.C[H.name], H.value);
                      break;
                    case "1i":
                      b.uniform1i(r.C[H.name], H.value);
                      break;
                    case "mat2":
                      b.uniformMatrix2fv(r.C[H.name], !1, H.value);
                      break;
                    case "mat3":
                      b.uniformMatrix3fv(r.C[H.name], !1, H.value);
                      break;
                    case "mat4":
                      b.uniformMatrix4fv(r.C[H.name], !1, H.value);
                  }
                });
              },
              rh: function () {
              ...
              m: function () {
                ...
                for (var f in v) {
                  var l = v[f];
                  l.ua && ((l.ua = !1), b.deleteProgram(l.xa));
                  l.zf && delete v[f];
                }
        ...
        Ha = (function () {
          ...
          function d(w, D, e) {
            w.setAttribute("width", D);
            w.setAttribute("height", e);
          }
          function g(w) {
            function D() {
              Ca.m();
              Y.reset();
              z.getExtension("WEBGL_lose_context").loseContext();
            }
            if (c()) return !1;
          ...
          function k(w) {
            ...
            w.GENERATE_MIPMAP_HINT &&
              w.FASTEST &&
              w.hint(w.GENERATE_MIPMAP_HINT, w.FASTEST);
          ...
          var p = null,
            ...
            B = {
              ...
              bf: function () {
                y || (y = new Uint8Array(p.width * p.height * 4));
                b.readPixels(
                  0,
                  0,
                  p.width,
              ...
              lh: function () {
                ...
                for (
                  var w = B.bf(),
                    D = n.createImageData(q.width, q.height),
                    e = q.width,
                    z = q.height,
                    A = D.data,
                    h = 0;
              ...
              jh: function (w) {
                !q &&
                  ...
                  ((q = document.createElement("canvas")),
                  (n = q.getContext("2d")));
                var D = w ? q : document.createElement("canvas");
                d(D, p.width, p.height);
                (w ? n : D.getContext("2d")).drawImage(p, 0, 0);
                return D;
              },
              A: function (w) {
                w = Object.assign(
                ...
                w.la
                  ? ((b = w.la), (p = w.la.canvas))
                  : w.fd && !w.kb
                  ? (p = document.getElementById(w.fd))
                  : w.kb && (p = w.kb);
                ...
                if (b) r = b instanceof WebGL2RenderingContext;
                  ...
                  navigator &&
                    ...
                    (D.antialias = !1);
                  var e = g(D);
                  e || !D.antialias || c() || ((D.antialias = !1), (e = g(D)));
                  e && (b = p.getContext("webgl2", D));
                  b
                    ? (r = !0)
                    : ((b = p.getContext("webgl", D)) ||
                        (b = p.getContext("experimental-webgl", D)),
                      (r = !1));
                }
                if (!b) return a("WebGL1 and 2 are not enabled");
                w.zc &&
                  p.addEventListener &&
                  (m = b.getExtension("WEBGL_lose_context")) &&
                  ((C = w.zc), p.addEventListener("webglcontextlost", C, !1));
        ...
        Aa = (function () {
          ...
          function c(f) {
            ...
            return 103 > M
              ? l
              : 142 < M
              ? l | 31744 | ((255 == M ? 0 : 1) && f & 8388607)
              : 113 > M
              ? ((H |= 2048), l | ((H >> (114 - M)) + ((H >> (113 - M)) & 1)))
              : (l = (l | ((M - 112) << 10) | (H >> 1)) + (H & 1));
          }
          function d(f) {
            var l = new Uint16Array(f.length);
          ...
          function g() {
            ...
            var f = p(d([0.5, 0.5, 0.5, 0.5]), !0);
            return null === f ? !0 : (O.nc = f);
          }
          function k() {
            if (null !== O.oc) return O.oc;
            var f = p(new Uint8Array([127, 127, 127, 127]), !1);
            return null === f ? !0 : (O.oc = f);
          }
          function p(f, l) {
            if (!xa.Cb() || !D) return null;
            var H = null,
              M = Math.sqrt(f.length / 4);
            try {
              var Q = b.getError();
              if ("FUCKING_BIG_ERROR" === Q) return !1;
              H = N.instance({ isFloat: !1, R: l, array: f, width: M });
              Q = b.getError();
              if (Q !== b.NO_ERROR) return !1;
            } catch (fa) {
              return !1;
            }
            oa.O();
            ...
            f = 4 * M * M;
            l = new Uint8Array(f);
            b.readPixels(0, 0, M, M, b.RGBA, b.UNSIGNED_BYTE, l);
            M = !0;
            for (Q = 0; Q < f; ++Q) M = M && 3 > Math.abs(l[Q] - 127);
            H.remove();
            oa.fa();
            return M;
          }
          var q = 0,
            ...
            N = {
              A: function () {
                D ||
                  ((B = [b.RGBA, null, b.RGBA, b.RGBA]),
                  (w = [b.RGBA, null, b.RGBA, b.RGBA]),
                  (n = [
                    b.TEXTURE0,
                    b.TEXTURE1,
                    b.TEXTURE2,
                  ...
                  u && JEContext.Lh() && n.push(b.TEXTURE8, b.TEXTURE9),
                  (r = [-1, -1, -1, -1, -1, -1, -1, -1]),
              ...
              tf: function () {
                if (!y) {
                  for (var f = new Float32Array(16384), l = 0; 16384 > l; ++l)
                    f[l] = 2 * Math.random() - 1;
                  y = {
                    random: N.instance({
                      isFloat: !0,
              ...
              Zf: function () {
                w = B = [b.RGBA, b.RGBA, b.RGBA, b.RGBA];
              },
              ae: function (f) {
                G.set("s1");
                oa.O();
              ...
              Th: function (f, l) {
                N.ae(f);
                b.readPixels(0, 0, f.J(), f.W(), b.RGBA, b.UNSIGNED_BYTE, l);
              },
              Uh: function (f, l) {
                N.ae(f);
                return Y.Mb(0, 0, f.J(), f.W(), l);
              },
              td: function (f, l, H, M, Q, fa, ta) {
                f.activeTexture(f.TEXTURE0);
                var Da = f.createTexture();
                f.bindTexture(f.TEXTURE_2D, Da);
                ...
                f.pixelStorei(f.UNPACK_FLIP_Y_WEBGL, fa);
                f.texImage2D(
                  f.TEXTURE_2D,
                  0,
                  f.RGBA,
              ...
              Vb: function (f) {
                f !== q && (b.activeTexture(n[f]), (q = f));
              },
              instance: function (f) {
                var l;
                function H() {
                  T = void 0 !== E.H.videoWidth ? E.H.videoWidth : E.H.width;
                  U = void 0 !== E.H.videoHeight ? E.H.videoHeight : E.H.height;
                }
                function M(J) {
                  var R = b.getError();
                  if ("FUCKING_BIG_ERROR" === R) return !1;
                  b.texImage2D(b.TEXTURE_2D, 0, ka, ha, ia, J);
                  R = b.getError();
                  R !== b.NO_ERROR &&
                    ha !== b.RGBA &&
                    ((ha = b.RGBA),
                ...
                function Q() {
                  if (!Db) {
                    ...
                    E.isAnisotropicFiltering &&
                      ...
                      b.texParameterf(
                        b.TEXTURE_2D,
                        JEContext.mh().TEXTURE_MAX_ANISOTROPY_EXT,
                        JESETTINGS.sg
                      );
                    b.texParameteri(
                      b.TEXTURE_2D,
                    ...
                    if (
                      (E.R && !E.isFloat) ||
                      (E.isFloat && E.isMipmap && Ca.Df())
                    )
                      (ka = Y.ef()), (ia = Y.jc(b));
                    E.uc && (cb = E.uc);
                    E.isSrgb && 4 === E.Gb && (ha = JEContext.yh());
                    if (E.H) M(E.H);
                    else if (E.url) M(Ga);
                    else if (ua) {
                      J = ua;
                    ...
                    Ua = !0;
                    E.D && ca && (E.D(ca), (E.D = null));
                  }
                }
                function fa() {
                  for (var J = T * U, R = 2 * J, la = 3 * J, W = 0; W < J; ++W)
                    (ya[0][W] = Va[W]),
                      (ya[1][W] = Va[W + J]),
                      (ya[2][W] = Va[W + R]),
                      (ya[3][W] = Va[W + la]);
                ...
                function ta() {
                  ...
                  eb = new Uint8Array(4 * J);
                  Va = new Float32Array(eb.buffer);
                  Wa = !0;
                }
                function Da() {
                  l = new Uint8Array(T * U * 4);
                  Eb = new Float32Array(l.buffer);
                  qb = !0;
                }
                var E = Object.assign({}, z, f),
                  Xa = m++;
                ...
                E.R = E.R || E.isFloat;
                E.R && (pb = 1);
                !E.yf && E.isFloat && I && !Y.bd() && (E.isFloat = !1);
                E.isFloat && (pb = 2);
                E.isAnisotropicFiltering &&
                  u &&
                  !JEContext.Eh() &&
                  (E.isAnisotropicFiltering = !1);
                var ra = E.mc || b.createTexture(),
                  Ga = null,
                  ua = !1,
                  T = 0,
                  U = 0,
                ...
                var ca = {
                  ...
                  Be: function (J, R) {
                    La
                      ? (J || (J = ca.xd()), N.Vb(R), a(Ra[J]), (r[R] = -1))
                      : ca.h(R);
                  },
                  xd: function () {
                    -1 === cb && (cb = Math.log(T) / Math.log(2));
                    return cb;
                  },
                  Ze: function (J) {
                    J || (J = ca.xd());
                    if (La) {
                      G.set("s12");
                      N.Vb(0);
                      for (var R = T, la = U, W = 1; W <= J; ++W)
                        (R /= 2),
                          (la /= 2),
                          G.V("u14", 0.25 / R, 0.25 / la),
                          b.viewport(0, 0, R, la),
                          a(Ra[W - 1]),
                          b.framebufferTexture2D(
                            oa.kc(),
                  ...
                  bi: function (J) {
                    (Fb = !Vb.jg(J)) ? ((ua = null), (E.H = J), H()) : (ua = J);
                  },
                  h: function (J) {
                    if (!Ua) return !1;
                    N.Vb(J);
                  ...
                  refresh: function () {
                    ...
                    Fb
                      ? b.texImage2D(b.TEXTURE_2D, 0, ka, ha, ia, E.H)
                      : b.texImage2D(b.TEXTURE_2D, 0, ka, T, U, 0, ha, ia, ua);
                    za && b.pixelStorei(b.UNPACK_FLIP_Y_WEBGL, !1);
                  },
                  Zd: function () {
                    Wa || ta();
                  ...
                  Uf: function () {
                    qb || Da();
                    b.readPixels(0, 0, T, U, b.RGBA, b.UNSIGNED_BYTE, l);
                    return Eb;
                  },
                  Tf: function () {
                    qb || Da();
                    return Y.Mb(0, 0, T, U, l);
                  },
                  gd: function (J) {
                    oa.O();
                    G.set("s15");
                    ...
                    if (J)
                      b.viewport(0, 0, T, U),
                        G.cg("u15", 0.25, 0.25, 0.25, 0.25),
                        ma.l(!1, !0);
                    else
                      for (J = 0; 4 > J; ++J)
                        b.viewport(0, U * J, T, U),
                          G.je("u15", t[J]),
                          ma.l(!1, 0 === J);
                  },
                  Sb: function (J) {
                    ...
                    R
                      ...
                      : b.texImage2D(b.TEXTURE_2D, 0, ka, T, U, 0, ha, ia, J);
                    r[q] = Xa;
                    za && b.pixelStorei(b.UNPACK_FLIP_Y_WEBGL, !1);
                  },
                  ni: function (J, R) {
                  ...
                  $h: function (J, R) {
                    ...
                    ca.h(0);
                    W = null;
                    if ("RGBA" === J || "RGBE" === J || "RGBAARRAY" === J) {
                      b.viewport(0, 0, T, U);
                      ma.l(!0, !0);
                      b.readPixels(0, 0, T, U, b.RGBA, b.UNSIGNED_BYTE, Ea);
                      if ("RGBAARRAY" === J) return { data: Ea };
                      A ||
                      ...
                      h.width = T;
                      h.height = U;
                      la = F.createImageData(T, U);
                      la.data.set(Ea);
                      F.putImageData(la, 0, 0);
                      W = h.toDataURL("image/png");
                    } else if ("JSON" === J)
                      if (R)
                    ...
                    return {
                      ...
                      height: U,
                      isMirrorY: E.isMirrorY,
                      isFlipY: "RGBA" === J ? E.isFlipY : !E.isFlipY,
                    };
                  },
                };
                E.isMipmap && !La && Ua && !db && (ca.ic(), (db = !0));
                if (E.url)
                  a(ra),
                    b.texImage2D(
                      b.TEXTURE_2D,
                  ...
                  E.array
                    ? (E.R && !E.isFloat
                        ? E.array instanceof Uint16Array
                          ...
                          : g()
                          ? ((ua = d(E.array)), Q())
                          : (Q(), N.td(b, ra, ca.J(), ca.W(), E.array, za, !0))
                        : ((ua = E.isFloat
              ...
              reset: function () {
                ...
                for (var f = 0; f < n.length; ++f) r[f] = -1;
                q = -1;
              },
              Xh: function () {
                q = -1;
              ...
              lg: function () {
                for (var f = 0; f < n.length; ++f) N.O(f);
              },
              ud: function () {
                y && (y.random.remove(), y.se.remove());
              },
              mi: function (f, l) {
        ...
        ma = (function () {
          function a(m) {
            var r = { da: null, indices: null };
            r.da = m.createBuffer();
            m.bindBuffer(m.ARRAY_BUFFER, r.da);
            m.bufferData(
              m.ARRAY_BUFFER,
          ...
          var c = null,
            ...
            n = {
              ...
              instance: function (m) {
                var r = d++,
                  y = m.indices ? m.indices.length : 0,
                  C = "undefined" === typeof m.mode ? b.STATIC_DRAW : m.mode,
                  x = b.createBuffer();
                b.bindBuffer(b.ARRAY_BUFFER, x);
                b.bufferData(
                  b.ARRAY_BUFFER,
                  m.da instanceof Float32Array ? m.da : new Float32Array(m.da),
                  C
                );
                p = r;
                var B = null,
                ...
                if (m.indices) {
                  B = b.createBuffer();
                  b.bindBuffer(b.ELEMENT_ARRAY_BUFFER, B);
                  var e = null;
                  65536 > m.indices.length
                    ? ((e = Uint16Array), (w = b.UNSIGNED_SHORT), (D = 2))
                    : ((e = Uint32Array), (w = b.UNSIGNED_INT), (D = 4));
                  e = m.indices instanceof e ? m.indices : new e(m.indices);
                  b.bufferData(b.ELEMENT_ARRAY_BUFFER, e, C);
                  q = r;
                }
                var z = {
                  Ce: function (A) {
                    p !== r && (b.bindBuffer(b.ARRAY_BUFFER, x), (p = r));
                    A && xa.Lc();
                  },
                  ze: function () {
                    q !== r &&
                      (b.bindBuffer(b.ELEMENT_ARRAY_BUFFER, B), (q = r));
                  },
                  bind: function (A) {
                    z.Ce(A);
                    z.ze();
                  ...
                  Lg: function () {
                    b.drawElements(b.TRIANGLES, y, w, 0);
                  },
                  Mg: function (A, h) {
                    b.drawElements(b.TRIANGLES, A, w, h * D);
                  },
                  remove: function () {
                    b.deleteBuffer(x);
                    m.indices && b.deleteBuffer(B);
                    z = null;
                  },
                };
                k.push(z);
            ...
            q = {
              ...
              A: function () {
                if (!g) {
                  ...
                  var n = Y.na();
                  c =
                    n && b.DRAW_FRAMEBUFFER
                      ? b.DRAW_FRAMEBUFFER
                      : b.FRAMEBUFFER;
                  d =
                    n && b.READ_FRAMEBUFFER
                      ? b.READ_FRAMEBUFFER
                      : b.FRAMEBUFFER;
                  g = !0;
                }
              ...
              instance: function (n) {
                ...
                var m = n.K ? n.K : null,
                  r = n.width,
                  y = void 0 !== n.height ? n.height : n.width,
                  C = a,
                  x = null,
                  B = !1,
                  w = !1,
                  D = 0;
                m && ((r = r ? r : m.J()), (y = y ? y : m.W()));
                var e = {
                  fe: function () {
                    B || ((C = b.createFramebuffer()), (B = !0), (D = p.sd++));
                  },
                  ue: function () {
                    e.fe();
                    e.o();
                  ...
                  bind: function (z, A) {
                    D !== p.I && (b.bindFramebuffer(c, C), (p.I = D));
                    m && m.o();
                    A && b.viewport(0, 0, r, y);
                    z && b.clear(b.COLOR_BUFFER_BIT | b.DEPTH_BUFFER_BIT);
                  },
                  tg: function () {
                    D !== p.I && (b.bindFramebuffer(c, C), (p.I = D));
                  },
                  ...
                  rtt: function (z) {
                    m = z;
                    p.I !== D &&
                      (b.bindFramebuffer(b.FRAMEBUFFER, C), (p.I = D));
                    z.o();
                  },
                  O: function () {
              ...
              fa: function () {
                0 !== p.I && (b.bindFramebuffer(c, a), (p.I = 0));
              },
              clear: function () {
                Y.ke();
                b.clear(b.COLOR_BUFFER_BIT);
        ...
        Y = (function () {
          ...
          function c(h, F) {
            for (var t = 0; t < h.length; ++t) {
              var u = F.getExtension(h[t]);
              if (u) return u;
            }
            return null;
          }
          function d() {
            null !== e.Rb && (clearTimeout(e.Rb), (e.Rb = null));
            e.Ga = !1;
          }
          function g(h) {
            if (0 === e.ta.length) {
              e.X = b.PIXEL_PACK_BUFFER;
              e.ta.splice(0);
              e.ub.splice(0);
              for (var F = 0; F < e.Sa; ++F)
                e.ta.push(b.createBuffer()), e.ub.push(-1);
              e.ja = 0;
              e.xc = 0;
            }
            b.bindBuffer(e.X, e.ta[e.ja]);
            h.byteLength !== e.ub[e.ja] &&
              (b.bufferData(e.X, h.byteLength, b.STREAM_READ),
              (e.ub[e.ja] = h.byteLength));
            e.Ch = !0;
          }
          function k() {
            b.bindBuffer(e.X, null);
          }
          function p() {
            e.Da.forEach(function (h) {
              b.deleteSync(h);
            });
            e.Da.splice(0);
          }
          ...
          var n = null,
            ...
            A = {
              A: function () {
                ...
                if (!y.Gd) {
                  ...
                  if (y.Jd || A.na())
                    (y.Oc = A.pd(h)),
                      (y.Cf = y.Oc ? !0 : !1),
                      (z.GL_EXT_FLOATLINEAR = y.Oc);
                  y.Gd = !0;
                }
                if (!y.Hd) {
                  y.Pc = A.pb(h);
                  y.Pc && ((y.Kd = !0), (z.GL_EXT_HALFFLOAT = y.Pc));
                  if (y.Kd || A.na())
                    (y.Qc = A.qd(h)), (z.GL_EXT_HALFFLOATLINEAR = y.Qc);
                  y.Dh = y.Qc ? !0 : !1;
                  y.Hd = !0;
                }
                y.Xb = A.md(h);
                y.vf = y.Xb ? !0 : !1;
                z.GL_EXT_COLORBUFFERFLOAT = y.Xb;
                y.Yb = A.nd(h);
                y.wf = y.Yb ? !0 : !1;
                z.GL_EXT_COLORBUFFERHALFFLOAT = y.Yb;
                oa.A();
                Aa.A();
                if (!A.Oe()) return !1;
                ma.A();
              ...
              df: function () {
                return D || b.RGBA32F || b.RGBA;
              },
              ef: function () {
                return w || b.RGBA16F || b.RGBA;
              },
              af: function () {
                return x;
              },
              ...
              qe: function (h) {
                B = h;
                !h && e.Ga && (p(), b.bindBuffer(e.X, null), (e.Ga = !1));
              },
              Jh: function () {
                return e.Ga;
              },
              Pb: function (h, F, t) {
                function u() {
                  ...
                  h.bindFramebuffer(I, null);
                  h.deleteTexture(O);
                  h.deleteFramebuffer(v);
                }
                var I = h.FRAMEBUFFER,
                  L = h.NEAREST,
                  v = h.createFramebuffer();
                h.bindFramebuffer(I, v);
                ...
                h.texParameteri(h.TEXTURE_2D, h.TEXTURE_MAG_FILTER, L);
                h.texParameteri(h.TEXTURE_2D, h.TEXTURE_MIN_FILTER, L);
                h.texImage2D(h.TEXTURE_2D, 0, F, 3, 3, 0, h.RGBA, t, null);
                ...
                ma.rb(h);
                F = new Uint8Array(36);
                h.readPixels(0, 0, 3, 3, h.RGBA, h.UNSIGNED_BYTE, F);
                u();
                for (t = 0; 36 > t; ++t)
                  if (3 !== t % 4 && 3 < Math.abs(F[t] - 127)) return !1;
                return !0;
              },
              $b: function (h) {
                var F = { ka: !1, ma: !1 };
                ...
                h.clear(h.COLOR_BUFFER_BIT);
                h.RGBA32F &&
                  A.Pb(h, h.RGBA32F, h.FLOAT) &&
                  ((F.ka = !0), (D = h.RGBA32F));
                !F.ka &&
                  A.Pb(h, h.RGBA, h.FLOAT) &&
                  ((F.ka = !0), (D = h.RGBA));
                var t = A.jc(h);
                w = null;
                h.RGBA16F &&
                  A.Pb(h, h.RGBA16F, t) &&
                  ((F.ma = !0), (w = h.RGBA16F));
                !F.ma && A.Pb(h, h.RGBA, t) && ((F.ma = !0), (w = h.RGBA));
                return F;
              },
              Pe: function () {
                var h = oa.instance({ width: 2 });
                h.fe();
                var F = Aa.instance({ width: 2, isFloat: !0, Gb: 3 });
                h.o();
                F.o();
                A.flush();
                b.checkFramebufferStatus(oa.gf()) !== b.FRAMEBUFFER_COMPLETE
                  ? (Aa.Zf(), (x.hc = !1))
                  : (x.hc = !0);
                h.remove();
                F.remove();
              ...
              $d: function (h, F, t, u, I) {
                b.readPixels(h, F, t, u, b.RGBA, b.UNSIGNED_BYTE, I);
                return Promise.resolve(I, !1);
              },
              Mb: function (h, F, t, u, I, L, v) {
                if (!A.Fe()) return A.$d(h, F, t, u, I);
                e.Sa = v || e.Me;
                g(I);
                b.readPixels(h, F, t, u, b.RGBA, b.UNSIGNED_BYTE, 0);
                e.Da[e.ja] = b.fenceSync(b.SYNC_GPU_COMMANDS_COMPLETE, 0);
                A.flush();
                var O = !1;
                return new Promise(function (N, f) {
                  function l() {
                    if (!e.Ga) return d(), k(), q(), f(), !1;
                    var H = (e.ja + 1) % e.Sa;
                    switch (b.clientWaitSync(e.Da[H], 0, 0)) {
                      ...
                      default:
                        return (
                          ...
                          b.deleteSync(e.Da[H]),
                          (e.Da[H] = null),
                          b.bindBuffer(e.X, e.ta[H]),
                          b.getBufferSubData(e.X, 0, I),
                          k(),
                          q(),
                          N(I, O),
                          !0
        ...
        Ca = (function () {
          function a(t, u, I, L) {
            ...
            if (null !== I)
              try {
                ...
                e.texImage2D(e.TEXTURE_2D, 0, t, 4, 4, 0, e.RGBA, u, I);
                v = e.getError();
                if (v !== e.NO_ERROR) return !1;
              } catch (O) {
                return !1;
              }
            ...
            if (v !== e.NO_ERROR) return !1;
            I = !0;
            for (L = 0; 16 > L; ++L) I = I && 4 > Math.abs(y[L] - 127);
            I && ((m.Vd = u), (m.Dd = t));
            return I;
          }
          function c(t, u) {
            return z.ka && a(t, e.FLOAT, new Float32Array(C), u)
              ? ((n = q.Yc), !0)
              : !1;
          }
          function d(t, u, I) {
            ...
            var L = Aa.Le(C),
              v = Y.pb(e);
            if (
              (v && v.HALF_FLOAT_OES && a(t, v.HALF_FLOAT_OES, L, u)) ||
              (e.HALF_FLOAT && a(t, e.HALF_FLOAT, L, u))
            )
              return (n = q.Na), !0;
            L = new Float32Array(C);
            if (a(t, e.FLOAT, L, u)) return (n = q.Na), !0;
            ...
            e.bindFramebuffer(m.mb, F);
            Aa.td(e, I, 2, 2, L, !1, !1);
            e.bindFramebuffer(m.mb, null);
            e.bindTexture(e.TEXTURE_2D, I);
            return a(t, null, null, u) ? ((n = q.Na), !0) : !1;
          }
          function g(t, u, I) {
            r = !0;
            if (d(t, !0, I) || c(u, !0)) return !0;
            r = !1;
            return d(t, !1, I) || c(u, !1) ? !0 : !1;
          }
          function k(t) {
            if (n === q.P) {
              e = t || b;
              ...
              m.mb = e.DRAW_FRAMEBUFFER || e.FRAMEBUFFER;
              e.bindFramebuffer(m.mb, null);
              ...
              L && (t = L);
              I && (u = I);
              if ((I || L) && g(u, t, h)) return p(), !0;
              t = u = e.RGBA;
              if (g(u, t, h)) return p(), !0;
              n = q.RGBA8;
              p();
              return !1;
            }
          ...
          function p() {
            e.deleteProgram(A.xa);
            e.deleteTexture(h);
            h = A = null;
          }
          for (
            var q = { P: -1, Yc: 3, Na: 2, RGBA8: 0 },
              n = q.P,
              m = { Vd: null, Dd: null, mb: null },
              r = !0,
              y = new Uint8Array(16),
              C = Array(64),
              x = 0;
          ...
          return {
            ...
            ad: function (t, u) {
              n === q.P && (typeof ("undefined" !== u) && (z = u), k(t));
              return n !== q.RGBA8;
            },
            Gh: function (t) {
              k(t);
          ...
          return {
            instance: function (a) {
              ...
              var d = null,
                ...
                m = null,
                r =
                  "undefined" === typeof a.preprocessing ? !1 : a.preprocessing,
                y =
              ...
              a.mask &&
                ((g = !0),
                ea && void 0 !== ea.ye && (a.mask = ea.ye + a.mask),
              ...
              y = Math.ceil(y);
              n && G.T(m, [{ name: "u29", type: "1f", value: a.tilt }]);
              g && (m += "Mask");
              var x = null;
              c();
              var B = {
            ...
            instance: function (a) {
              function c() {
                if (F.Ka) {
                  ...
                  h = Math.log(u / a.size) / Math.log(2);
                  k.input = aa.instance({
                    isMipmap: !0,
                    isFloat: !0,
                    isPot: !0,
              ...
              var k = {
                ...
                C = [a.Fa ? "s31" : "s30", a.Fa ? "s33" : "s32", "s34"][
                  a.shiftRGBAMode || 0
                ],
                x = { isEnabled: !1 },
                B = 1 / a.size;
              a.Af
                ? ((a.sparsity =
                    "undefined" !== typeof a.sparsity ? a.sparsity : a.Kb.lc()),
                  (q = !1))
                : "full" === a.connectivityUp && (a.sparsity = a.Kb.lc());
              var w = {
                  elu: "s18",
                  elu01: "s19",
                  relu: "s17",
              ...
              if (a.maxPooling) {
                ...
                e = !0;
                z /= a.maxPooling.size;
                k.Bc = aa.instance({ isFloat: !0, isPot: !1, width: z });
              }
              var h = -1,
                F = null;
              q && d();
              ...
              var t = {
                ...
                Pf: function () {
                  a.remap &&
                    ...
                    (x = {
                      isEnabled: !0,
                      Hf: aa.instance(a.remap.maskTexture),
                      ab: a.remap.layers.map(function (u) {
                        return a.parent.lf(u);
                      }),
                      depth: a.remap.depth,
                    });
                },
                ...
                U: function (u, I) {
                  ...
                  F.Ka
                    ? (k.input.S(),
                      ...
                      k.input.Ze(h),
                      k.xb.S(),
                      y ? G.set("s0") : (G.set(C), G.G("u4", D), k.bias.h(1)),
                      k.input.Be(h, 0),
                      P.l(!1, !1),
                      G.set(w),
                      k.wa.o(),
                  ...
                  switch (n.type) {
                    case "cpuRGBA2Float":
                      L.gd(!1);
                      I ? (u = t.Qf(L).then(n.D)) : ((L = t.Rf(L)), n.D(L));
                      break;
                    case "cpuMeanFloat":
                      L.gd(!0);
                      if (I) u = L.Tf().then(n.D);
                      else {
                        L = L.Uf();
            ...
            instance: function (a) {
              ...
              return {
                ...
                U: function (k) {
                  ...
                  a.Fa && G.ie("u21", a.Xa);
                  G.G("u8", a.toLayerSize);
                  G.G("u9", a.fromLayerSize);
                  d.h(1);
                  P.l(!1, !1);
                },
              };
          ...
          return {
            instance: function (a) {
              for (
                ...
                x[B] = 0;
              B = Math.floor(g / 2);
              for (var w = 0.5 / d, D = 0.5 / c, e = 0.5 / k, z = 0; z < d; ++z)
                for (var A = Math.round(z * q), h = 0; h < d; ++h) {
                  var F = Math.round(h * q),
                    t = z / d,
                    u = h / d;
                  t += w;
                  u += w;
        ...
        dc = (function () {
          return {
            instance: function (a, c) {
              ...
              G.We(y) ||
                ((a = Wb.$e(c, "gl_FragColor", "gl_FragColor")),
                (g = [
                  { type: "1f", name: "u8", value: g },
                  { type: "1f", name: "u32", value: p },
                ]),
                n && g.push({ type: "1f", name: "u9", value: d }),
                (d = [(n ? q : k).toFixed(1), a]),
                n && d.push(m.toFixed(1)),
                G.uf(n ? "s46" : "s45", y, d),
                G.T(
                  y,
                  g.concat([
        ...
        X = {
          ...
          Ne: function (a) {
            function c(x) {
              return [
                ...
                return Math.abs(B - x) - Math.abs(w - x);
              });
            }
            function d(x) {
              var B = X.dd(a);
            ...
            function g(x) {
              if (x.video && x.video.facingMode && x.video.facingMode.exact) {
                var B = x.video.facingMode.exact;
                x = X.dd(x);
                delete x.video.facingMode.exact;
                x.video.facingMode.ideal = B;
                k.push(x);
              }
            }
            var k = [];
            ...
            if (a.video.width && a.video.height) {
              if (a.video.width.ideal && a.video.height.ideal) {
                var p = c(a.video.width.ideal).slice(0, 3),
                  ...
                  n = {},
                  m = 0;
                for (n.ra = void 0; m < p.length; n = { ra: n.ra }, ++m) {
                  n.ra = p[m];
                  var r = {},
                    y = 0;
                  for (r.qa = void 0; y < q.length; r = { qa: r.qa }, ++y)
                    if (
                      ((r.qa = q[y]),
                      n.ra !== a.video.width.ideal ||
                        r.qa !== a.video.height.ideal)
                    ) {
                      var C = Math.max(n.ra, r.qa) / Math.min(n.ra, r.qa);
                      C < 4 / 3 - 0.1 ||
                        C > 16 / 9 + 0.1 ||
                        d(
                          (function (x, B) {
                            return function (w) {
                              w.video.width.ideal = x.ra;
                              w.video.height.ideal = B.qa;
                              return w;
                            };
                          })(n, r)
                        );
              ...
              : new Promise(function (g, k) {
                  if (a.srcObject && a.srcObject.getVideoTracks) {
                    ...
                    1 !== p.length
                      ...
                      : ((p = p[0]), c ? X.get(a, g, k, d) : (p.stop(), g()));
              ...
              .then(function (q) {
                function n() {
                  setTimeout(function () {
                    if (a.currentTime) {
                      var r = a.videoHeight;
                      if (0 === a.videoWidth || 0 === r) k("VIDEO_NULLSIZE");
                      else {
                        r = { Ge: null, eg: null, If: null };
                        try {
                          var y = q.getVideoTracks()[0];
                          y &&
                            ((r.If = y),
                            (r.Ge = y.getCapabilities()),
                            (r.eg = y.getSettings()));
                        } catch (C) {}
                        p || c(a, q, r);
                      }
          ...
          get: function (a, c, d, g) {
            ...
            if (!X.ed()) return d && d("MEDIASTREAMAPI_NOTFOUND"), !1;
            X.Ua(a, "autoplay");
            X.Ua(a, "playsinline");
            g && g.audio ? (a.volume = 0) : X.Ua(a, "muted");
            X.Ke(g).then(function () {
              X.yd(
                a,
                c,
                function () {
                  function k(q) {
                    if (0 === q.length) d("INVALID_FALLBACKCONSTRAINTS");
                    else {
                      var n = q.shift();
                      X.yd(
                        a,
        ...
        qa = (function () {
          ...
          var c = {
            ...
            w = {
              ...
              hh: function (D) {
                return Math.pow(
                  Math.min(Math.max(n, 0), g.n - 1) / (g.n - 1),
                  D || 1
                );
              },
              A: function (D) {
              ...
              Qb: function (D) {
                ...
                var e = Math.min(Math.max(D - y, g.ob[0]), g.ob[1]);
                C = e;
                y = D;
                var z = -1 === k ? 0 : g.k;
                k = Math.min(Math.max(1e3 / e, 5), 120) * (1 - z) + k * z;
                D - p > g.ng &&
                  5 < ++q &&
                  ((e = g.k),
                  (n =
                    n * (1 - e) +
                    (k < g.sb[0] ? m - 1 : k > g.sb[1] ? m + 1 : m) * e),
                  Math.abs(n - m) > 1 - g.Of &&
                    ((e = Math.min(Math.max(Math.round(n), 0), g.n - 1)),
                    e !== m && ((n = m = e), (k = (g.sb[1] - g.sb[0]) / 2))),
                  (p = D));
              },
              Fc: function (D, e, z, A, h, F) {
                B = !1;
                a(D, e, z, A, h, F, 0);
              },
              stop: function () {
        ...
        Na = (function () {
          ...
          function d(v) {
            h.Ha &&
              null !== w &&
              ((v -= D),
              (v = Math.min(Math.max(v, B.hd[0]), B.hd[1])),
              (D += v),
              p(),
              t.isEnabled &&
                t.$a &&
          ...
          function g(v) {
            h.Ha && (F.timeout = setTimeout(d.bind(null, v), B.gb));
          }
          function k() {
            w = null;
            h.Ha = !1;
          ...
          function p() {
            F.hb && (window.cancelAnimationFrame(F.hb), (F.hb = null));
          ...
          function r() {
            ...
            var v = t.la,
              ...
              N = t.wb,
              f = t.X;
            v.uniform1f(t.Bd, Math.random());
            t.Ia ? O.beginQueryEXT(f, N) : v.beginQuery(f, N);
            v.drawElements(v.POINTS, 1, v.UNSIGNED_SHORT, 0);
            t.Ia ? O.endQueryEXT(f) : v.endQuery(f);
            Y.flush();
            C()
              .then(function (l) {
                0 === l || isNaN(l)
                  ...
                  : ((l = (B.te * B.Vc * 1e3) / l),
                    ...
                    ++t.Nd > B.La &&
                      (t.Db.set(t.tc),
                      t.Db.sort(function (H, M) {
                        return H - M;
                      }),
                      (l = t.Db[Math.floor(B.La / 2)]),
                      (t.qb = Math.max(t.qb, l)),
                      B.Uc(l / t.qb)),
                    (t.$a = !0));
              })
              .catch(function () {
          ...
          function y(v) {
            var O = t.la,
              ...
              f = t.wb;
            f = t.Ia
              ? N.eh(f, N.QUERY_RESULT_AVAILABLE_EXT)
              : O.getQueryParameter(f, O.QUERY_RESULT_AVAILABLE);
            O = O.getParameter(N.GPU_DISJOINT_EXT);
            f ? v(!O) : setTimeout(y.bind(null, v), 0.1);
          }
          function C() {
              ...
              y(function (N) {
                if (N) {
                  ...
                  var f = t.vb,
                    l = t.wb;
                  N = t.Ia
                    ? f.getQueryObjectEXT(l, f.QUERY_RESULT_EXT)
                    : N.getQueryParameter(l, N.QUERY_RESULT);
                  v(N);
                } else O();
              });
            });
          ...
          var x = {
            ...
            z = !1,
            A = null,
            h = { ua: !1, $: !0, rc: !1, qc: !1, pc: !1, Ha: !1 },
            F = { hb: null, timeout: null },
            t = {
              isEnabled: !1,
              $a: !1,
              la: null,
            ...
            L = {
              A: function (v) {
                ...
                if (null !== B.Uc) {
                  ...
                  if (
                    ...
                    v.attachShader(l, f);
                    v.linkProgram(l);
                    N = v.getAttribLocation(l, "a0");
                    t.Bd = v.getUniformLocation(l, "u39");
                    v.useProgram(l);
                    ...
                    l = v.createBuffer();
                    v.bindBuffer(v.ELEMENT_ARRAY_BUFFER, l);
                    v.bufferData(
                    ...
                    v.viewport(0, 0, 1, 1);
                    l = t.Ia ? O.createQueryEXT() : v.createQuery();
                    t.wb = l;
                    t.X = O.TIME_ELAPSED_EXT || v.TIME_ELAPSED;
                    t.sc = -B.Wc;
                    t.tc = new Float32Array(B.La);
                    t.Db = new Float32Array(B.La);
                    t.qb = 0;
                    t.Ub = 0;
                    t.Nd = 0;
                    t.$a = !0;
                  ...
                  try {
                    if ("undefined" === typeof SharedWorker) {
                      ...
                      var Q = URL.createObjectURL(
                        ...
                        fa = new SharedWorker(Q);
                      fa.port.start();
                      fa.port.addEventListener("message", a);
                      e = { Xd: fa, port: fa.port };
                      h.qc = !0;
                    }
                    v = !0;
                  } catch (ta) {}
              ...
              m: function () {
                ...
                h.qc
                  ? (e.port.close(), (h.qc = !1))
                  : h.rc && (e.Xd.terminate(), (h.rc = !1));
                Object.assign(h, { $: !0, ua: !1, Ha: !1 });
                w = null;
              },
              Mh: function () {
                return h.$;
        ...
        Ta = (function () {
          ...
          return {
            A: function (C) {
              ...
              var x = d.Jb[1] * d.N[1],
                B = 1 / (1 + d.Jb[2] * d.N[2]),
                w = d.be * Math.min(d.u, d.L),
                D = w / d.u;
              w /= d.L;
              var e = 0.5 * d.Te;
              e *= e;
              for (var z = 0; z < d.Td; ++z) {
                var A = [];
                k.push(A);
                var h = Math.pow(B, z),
                  F = D * h,
                ...
                t /= 2;
                for (
                  var L = 1 + (1 - F - F) / u, v = 1 + (1 - t - t) / I, O = 0;
                  O < v;
                  ++O
                )
                  for (var N = t + O * I, f = N - 0.5, l = 0; l < L; ++l) {
                    var H = F + l * u,
                      M = H - 0.5;
                    M * M + f * f > e ||
                      ((H = [H, N, h]), g.push(H), A.push(H));
                  }
                d.Hc && A.sort(a);
                m = g;
              }
            ...
            get: function (C) {
              var x = m.length;
              if (0 === x) return n;
              for (; C >= q.length; ) q.push(0);
              q[C] >= x && (q[C] = 0);
              var B = m[Math.floor(q[C]) % x];
              q[C] = (q[C] + 1 / d.ig) % x;
              if (0 === r) return B;
              y[0] = B[0];
              y[1] = B[1];
            ...
            Sh: function (C) {
              C >= q.length || (q[C] = Math.floor(Math.random() * m.length));
            },
            Jc: function (C) {
              r = C;
              if (0 === r) m = g;
              else {
                for (var x = p.length, B = x - 1, w = 0; w < x; ++w)
                  if (p[w] <= C) {
                    B = w;
                    break;
                  }
            ...
            reset: function () {
              for (var C = g.length / q.length, x = 0; x < q.length; ++x)
                q[x] = Math.floor(x * C);
              r = 0;
              m = g;
            },
        ...
        da = (function () {
          ...
          function g(e, z, A) {
            var h = Math.abs(-e.eb * (A - e.ia[1]) - e.Ta * (z - e.ia[0]));
            z = Math.abs(e.Ta * (A - e.ia[1]) - e.eb * (z - e.ia[0]));
            return 1 >= (h * h) / e.Eb[0] + (z * z) / e.Eb[1];
          }
          function k(e, z, A, h) {
            var F = e[A];
            d(e, z, h);
            var t = w[A];
            return e.some(function (u, I) {
              if (
                !(u =
                  I === A ||
                  F.va > u.va ||
                  3 > u.va ||
                  !(0 < a(F.x, F.ca * B, u.x, u.ca * B)) ||
                  !(0 < a(F.y, F.ca * h * B, u.y, u.ca * h * B)))
              ) {
                u = w[I];
                t.scale > u.scale ? (I = t) : ((I = u), (u = t));
                for (var L = 0, v = 0, O = n.Ue, N = 0; N < O; ++N)
                  for (
                    var f = (((N + 0.5) / O) * 2 - 1) * u.oa[1], l = 0;
                    l < O;
                    ++l
                  ) {
                    var H = (((l + 0.5) / O) * 2 - 1) * u.oa[0],
                      M = u.ia[0] + (-f * u.eb + H * u.Ta);
                    H = u.ia[1] + (f * u.Ta + H * u.eb);
                    g(u, M, H) && (++L, g(I, M, H) && ++v);
                  }
                u = v / L < n.Pd;
              }
          ...
          var q = {
            ...
            D = {
              ...
              update: function (e, z) {
                var A = r;
                if (A.length > e) A.splice(0, A.length - e);
                else for (; A.length < e; ) A.push(0);
                if (1 !== n.M)
                  if (z.every(c)) {
                    z = C;
                    for (var h = 0; h < e; ++h) (A[h] = z), (z = (z + 1) % n.M);
                    C = z;
                  } else {
                    h = Math.round(n.de * e);
                    h = Math.max(1, h);
                    for (var F = C, t = 0, u = 0; t < e; ++t) {
                      if (c(z[F]) && ++u > h) {
                        do ++F === n.M && (F = 0);
                        while (c(z[F]));
                      }
              ...
              bh: function (e) {
                return e.findIndex(p);
              },
              $g: function (e) {
                var z = D.Ye(e);
                if (!z || e.every(p)) return Ta.Jc(0), !1;
                Ta.Jc(z.s);
                return !0;
              },
              Se: function (e) {
                for (
                  var z = new Float32Array(e.length * n.M), A = 0, h;
                  A < n.M;
                  ++A
                )
                  for (h = 0; h < e.length; ++h) z[A * e.length + h] = e[h];
                return z;
              },
              fc: function (e) {
        ...
        ja = { yc: -3, Gf: -1, error: -2, ready: 1, play: 2, pause: 3 },
        na = ja.yc,
        K = null,
        gc = {
          Ab: !1,
        ...
        sb = {
          ...
          init: function (a) {
              ...
              na !== ja.error &&
                ...
                S.Qa &&
                  ...
                  S.Qa(!1, {
                    GL: b,
                    canvasElement: S.ha,
                    videoTexture: K.K.get(),
                    videoTransformMat2: K.B,
                    maxFacesDetected: da.sa(),
                    videoElement: K.element,
                  }),
                  ib()),
                hb());
            }
            ...
            for (d = 0; d < da.sa(); ++d)
              jb.push(new Float32Array(ea.Mf)), kb.push(0);
            Na.A({ Id: a.isKeepRunningOnWinFocusLost || !1, gb: S.ea });
            qa.A({
              wc: 0,
              n: ba.nDetectsPerLoopRange[1] - ba.nDetectsPerLoopRange[0] + 1,
              Od: ba.nDetectsPerLoopRange[0],
            });
            -1 !== ba.nDetectsPerLoop ? qa.Ic(ba.nDetectsPerLoop) : qa.Sc();
            V.N = ba.translationScalingFactors.slice(0);
            sa = Object.create(ea.hg);
            a.stabilizationSettings &&
              Object.assign(sa, a.stabilizationSettings);
            var g = 0;
            a.videoSettings && a.videoSettings.videoElement
              ...
              : (a.videoSettings && Object.assign(pa, a.videoSettings),
                Cb(a.onWebcamAsk, a.onWebcamGet, function (k) {
                  bb(k, c);
                }));
            Sb(function (k) {
              if (!Tb()) return !1;
              Pa = new Jb({ ab: k.layers, Ib: "gpuRawAvg", Hb: Ub });
              G.fb([
                {
                  id: "s62",
                  name: "_",
              ...
              yb();
              V.buffer = new Uint8Array(8 * ea.le * da.sa());
              Sa = da.fc({
                lb: 0,
                x: 0,
                y: 0,
          ...
          toggle_videoStream: function (a) {
            return K.zb || !K.element
              ? Promise.resolve()
              : X.re(K.element, a, K.Ra);
          },
          ...
          update_videoSettings: function (a) {
            wb();
            return new Promise(function (c, d) {
              X.re(K.element, !1, K.Ra)
                .then(function () {
                  Object.assign(pa, a);
                  Cb(null, null, function (g) {
                    bb(g, function () {
                      Ka();
                      Ja();
                      hb();
            ...
            Za() &&
              ...
              (a && !S.Bb
                ? ((S.Wd = S.ea),
                  ...
                  this.set_animateDelay(ea.rg),
                  (S.Bb = !0))
                : !a &&
                  S.Bb &&
                  ((ba.nDetectsPerLoop = -1),
                  this.set_animateDelay(S.Wd),
                  (S.Bb = !1)));
          },
          ...
          set_inputTexture: function (a, c, d) {
            K.F[0] = c;
            K.F[1] = d;
            K.K = aa.instance({ width: c, height: d, mc: a });
            K.Ab = !0;
            Ka();
            ib();
            Ja();
