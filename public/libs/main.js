...
function init_threeScene(spec) {
  ...
  // helmetLoader.load("/models/helmet/helmet.json", (helmetGeometry) => {
  ...
  */
  maskLoader.load(
    "/models/face/faceLowPolyEyesEarsFill2.json",
  ...
  //   create_mat2d(new THREE.TextureLoader().load("/images/frame_rupy.png"), true)
  // );
